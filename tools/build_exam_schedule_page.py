#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""試験日検索ページ exam-dates/index.html を生成する。"""
...
EXAM_DATES_CSS_VER = "20260628-exam-schedule-eisei2"

AUTHOR_NAME = "二衛マスター編集部"
AUTHOR_PROFILE = (
    "第二種衛生管理者試験の学習設計・演習運用を専門とする編集チーム。"
    "関係法令・労働衛生・労働生理の三領域を横断し、受験者が迷わない導線づくりを担当しています。"
)
REVIEWER_NAME = "公式情報確認担当"
REVIEWER_PROFILE = (
    "安全衛生技術試験協会の公開情報と照合し、"
    "試験日程とサイト内リンクの整合を確認した担当者です。"
)
PRIMARY_SOURCES = [
    {
        "label": "安全衛生技術試験協会（公式）",
    ...
    {
        "label": "第一種・第二種衛生管理者の日程",
        "url": OFFICIAL_SCHEDULE_URL,
    },
]
...
def related_links_html() -> str:
    links = [
        ...
        ("../articles/application-deadline-checklist/", "申込チェックリスト"),
...
def build_page_html() -> str:
    ...
    js_src = html.escape("../site-exam-schedule.js", quote=True)
